...
<head>  
	...
	<title>CPanel - Baja de producto</title>  
...
<body>
	   	...
	   	<tbody>
		   	<?php foreach ($productos as $p) {?>
				<tr <?php if(alternator('0', '1')) { echo 'class="alt"'; }?>>					
				    ...
				    <td><?=$p['imagen']?></td>
				    <td></td>				    
				    <td><?php echo form_open('baja/baja_producto');		   					  	  	  
				    		  echo form_hidden('id_producto', $p['id_producto']);		  
				    	 	  echo form_submit('baja', 'Eliminar');?></td> 		    		
			   			<?php echo form_close();?>	   			
			    </tr>  					
			<?php } ?>
	   	</tbody>
	...
	<h2>Proveedores</h2>
	<table width="100%" cellpadding="0" cellspacing="0" class="baja_lista">  
	   	<thead>  
	       	<tr>	       		
	   	...
	   	<tbody>
		   	<?php foreach ($proveedores as $pr) {?>
				<tr <?php if(alternator('0', '1')) { echo 'class="alt"'; }?>>					
				    ...
				    <td><?=$pr['localidad']?></td>					    				    
				    <td></td>				    
				    <td><?php echo form_open('baja/baja_proveedor');		   					  	  	  
	   	...
	   	<tbody>
		   	<?php foreach ($categorias as $c) {?>
				<tr <?php if(alternator('0', '1')) { echo 'class="alt"'; }?>>					
				    <td><?=$c['nombre']?></td>				    			    
				    <td></td>				    
				    <td><?php echo form_open('baja/baja_categoria');		   					  	  	  
